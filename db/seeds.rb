...
event = Event.new({
                      ...
                      start_time: DateTime.new(2015, 11, 21, 07, 0, 0)
                  })

event.sub_events = SubEvent.create ([
                                       {
                                           name: "Sponsor Check-In and Setup",
                                           start_date: DateTime.new(2015, 11, 21, 07, 0, 0)
                                       },
                                       {
                                           name: "Breakfast: Einstein's Bagels - Sponsored by Tanvas",
                                           start_date: DateTime.new(2015, 11, 21, 07, 30, 0)
                                       },
                                       {
                                           name: "Participant Check-In",
                                           start_date: DateTime.new(2015, 11, 21, 8, 30, 0)
                                       },
                                       {
                                           name: "Opening Ceremony",
                                           start_date: DateTime.new(2015, 11, 21, 10, 30, 0)
                                       },
                                       {
                                           name: "Hacking Begins",
                                           start_date: DateTime.new(2015, 11, 21, 11, 30, 0)
                                       },
                                       {
                                           name: "Lunch: Chipotle - Sponsored by IMC Financial",
                                           start_date: DateTime.new(2015, 11, 21, 12, 30, 0)
                                       },
                                       {
                                           name: "Microsoft Tech Talk - Building Your First Node.js App and Publishing to Azure",
                                           start_date: DateTime.new(2015, 11, 21, 14, 0, 0)
                                       },
                                       {
                                           name: "HP Tech Talk - Harnessing the Power of Unstructured Data using Haven OnDemand",
                                           start_date: DateTime.new(2015, 11, 21, 14, 45, 0)
                                       },
                                       {
                                           name: "IBM Tech Talk - Introduction to Bluemix",
                                           start_date: DateTime.new(2015, 11, 21, 15, 30, 0)
                                       },
                                       {
                                           name: "Afternoon Snack: Portillos - Sponsored by IBM",
                                           start_date: DateTime.new(2015, 11, 21, 16, 0, 0)
                                       },
                                       {
                                           name: "PayPal/Braintree Tech Talk - Introduction to Braintree",
                                           start_date: DateTime.new(2015, 11, 21, 16, 45, 0)
                                       },
                                       {
                                           name: "Dinner",
                                           start_date: DateTime.new(2015, 11, 21, 19, 0, 0)
                                       },
                                       {
                                       ...
                                       },
                                       {
                                           ...
                                           start_date: DateTime.new(2015, 11, 21, 21, 30, 0)
                                       },
                                       {
                                           name: "Midnight Snack: Andy's Frozen Custard - Sponsored by Groupon",
                                           start_date: DateTime.new(2015, 11, 21, 23, 30, 0)
                                       },
                                       {
                                           name: "Breakfast",
                                           start_date: DateTime.new(2015, 11, 22, 8, 0, 0)
                                       },
                                       {
                                           name: "Hacking Ends",
                                       ...
                                       },
                                       {
                                           ...
                                           start_date: DateTime.new(2015, 11, 22, 13, 0, 0)
                                       },
                                       {
                                           name: "Final Judging and Closing Ceremony",
                                           start_date: DateTime.new(2015, 11, 22, 14, 30, 0)
                                       },
                                       {
                                           name: "Buses Leave",
                                           start_date: DateTime.new(2015, 11, 22, 17, 0, 0)
                                       }
                                   ])

event.save!

puts "Finished creating first event"
